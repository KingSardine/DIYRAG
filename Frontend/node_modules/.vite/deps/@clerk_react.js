...
// node_modules/@clerk/react/node_modules/@clerk/shared/dist/_chunks/error-CYyD2kei.mjs
var _a3;
...
function createRetryer(config) {
  ...
  const pause = () => {
    return new Promise((continueResolve) => {
      ...
      var _a17;
      continueFn = void 0;
      if (!isResolved()) (_a17 = config.onContinue) == null ? void 0 : _a17.call(config);
    });
  };
  const run = () => {
    ...
    Promise.resolve(promiseOrValue).then(resolve).catch((error) => {
      var _a17;
      if (isResolved()) return;
      const retry2 = config.retry ?? (isServer2() ? 0 : 3);
...
function infiniteQueryBehavior(pages) {
  return { onFetch: (context, query) => {
    ...
    if (context.options.persister) context.fetchFn = () => {
      var _a18, _b2;
      return (_b2 = (_a18 = context.options).persister) == null ? void 0 : _b2.call(_a18, fetchFn, {
        client: context.client,
        queryKey: context.queryKey,
        meta: context.options.meta,
...
var _queryType, _initialState, _revertState, _cache, _client, _retryer, _defaultOptions, _abortSignalConsumed, _Query_instances, dispatch_fn, _a9;
var Query = (_a9 = class extends Removable {
  ...
  onFocus() {
    var _a17, _b;
    (_a17 = this.observers.find((x) => x.shouldFetchOnWindowFocus())) == null ? void 0 : _a17.refetch({ cancelRefetch: false });
    (_b = __privateGet(this, _retryer)) == null ? void 0 : _b.continue();
  }
  onOnline() {
    var _a17, _b;
    (_a17 = this.observers.find((x) => x.shouldFetchOnReconnect())) == null ? void 0 : _a17.refetch({ cancelRefetch: false });
    (_b = __privateGet(this, _retryer)) == null ? void 0 : _b.continue();
  }
  ...
  async fetch(options, fetchOptions) {
    ...
    if (this.state.fetchStatus !== "idle" && ((_a17 = __privateGet(this, _retryer)) == null ? void 0 : _a17.status()) !== "rejected") {
...
var QueryObserver = (_a10 = class extends Subscribable {
  ...
  createResult(query, options) {
    ...
    if (options.placeholderData !== void 0 && data === void 0 && status === "pending") {
      ...
      if ((prevResult == null ? void 0 : prevResult.isPlaceholderData) && options.placeholderData === (prevResultOptions == null ? void 0 : prevResultOptions.placeholderData)) {
        ...
        skipSelect = true;
      } else placeholderData = typeof options.placeholderData === "function" ? options.placeholderData((_a17 = __privateGet(this, _lastQueryWithDefinedData)) == null ? void 0 : _a17.state.data, __privateGet(this, _lastQueryWithDefinedData)) : options.placeholderData;
  ...
  if (!(fetchOptions == null ? void 0 : fetchOptions.throwOnError)) promise = promise.catch(noop2);
  return promise;
...
var Mutation = (_a11 = class extends Removable {
  ...
  continue() {
    var _a17;
    return ((_a17 = __privateGet(this, _retryer2)) == null ? void 0 : _a17.continue()) ?? (this.state.status === "pending" ? this.execute(this.state.variables) : Promise.resolve());
  }
  async execute(variables) {
    ...
    try {
      if (restored) onContinue();
        ...
        const context = await ((_b = (_a17 = this.options).onMutate) == null ? void 0 : _b.call(_a17, variables, mutationFnContext));
...
var MutationCache = (_a12 = class extends Subscribable {
  ...
  canRun(mutation) {
    ...
    const scope = scopeFor(mutation);
    if (typeof scope === "string") {
      const firstPendingMutation = (_a17 = __privateGet(this, _scopes).get(scope)) == null ? void 0 : _a17.find((m) => m.state.status === "pending");
  ...
  runNext(mutation) {
    var _a17, _b;
    const scope = scopeFor(mutation);
    if (typeof scope === "string") return ((_b = (_a17 = __privateGet(this, _scopes).get(scope)) == null ? void 0 : _a17.find((m) => m !== mutation && m.state.isPaused)) == null ? void 0 : _b.continue()) ?? Promise.resolve();
  ...
  resumePausedMutations() {
    ...
    return notifyManager.batch(() => Promise.all(pausedMutations.map((mutation) => mutation.continue().catch(noop2))));
  }
...
var QueryClient = (_a14 = class {
  ...
  */
  ...
  setQueryData(queryKey, updater, options) {
    ...
    const prevData = (_a17 = __privateGet(this, _queryCache).get(defaultedOptions.queryHash)) == null ? void 0 : _a17.state.data;
  ...
  getQueryState(queryKey) {
    var _a17;
    const options = this.defaultQueryOptions({ queryKey });
    return (_a17 = __privateGet(this, _queryCache).get(options.queryHash)) == null ? void 0 : _a17.state;
  }
  ...
  refetchQueries(filters, options = {}) {
    ...
    const promises = notifyManager.batch(() => __privateGet(this, _queryCache).findAll(filters).filter((query) => !query.isDisabled() && !query.isStatic()).map((query) => {
      ...
      if (!fetchOptions.throwOnError) promise = promise.catch(noop2);
...
function useAttemptToEnableOrganizations(caller, { enabled = true } = {}) {
...
function useOrganization(params) {
  var _a17;
  const { domains: domainListParams, membershipRequests: membershipRequestsListParams, memberships: membersListParams, invitations: invitationsListParams, __internal_skipAttemptToEnableOrganizations } = params || {};
  useAssertWrappedByClerkProvider("useOrganization");
  useAttemptToEnableOrganizations("useOrganization", { enabled: !__internal_skipAttemptToEnableOrganizations });
...
function useOrganizationList(params) {
  ...
  useAttemptToEnableOrganizations("useOrganizationList", { enabled: userMemberships !== void 0 || userInvitations !== void 0 || userSuggestions !== void 0 });
...
var createElementComponent = (type, isServer3) => {
  ...
  const Element = isServer3 ? ServerElement : ClientElement;
...
// node_modules/@clerk/react/dist/hooks-74kNS3WZ.mjs
...
// node_modules/@clerk/react/dist/ClerkProvider-DY0lNOEl.mjs
...
var versionSelector = (clerkJSVersion, packageVersion = "6.30.2") => {
...
var clerkUIScriptUrl = (opts) => {
  ...
  const version2 = versionSelector(__internal_clerkUIVersion, "1.31.0");
...
var IsomorphicClerk = (_a15 = class {
  constructor(options) {
    ...
    this.setProtectAssertion = (assertion) => {
      const callback = () => {
        var _a18;
        return (_a18 = this.clerkjs) == null ? void 0 : _a18.setProtectAssertion(assertion);
      };
    ...
    this.__internal_resumeAfterProtectCheck = async (params, customNavigate) => {
      const callback = () => {
        var _a18;
        const clerkjs = this.clerkjs;
        if (typeof (clerkjs == null ? void 0 : clerkjs.__internal_resumeAfterProtectCheck) !== "function") return;
        (_a18 = clerkjs.__internal_resumeAfterProtectCheck(params, customNavigate)) == null ? void 0 : _a18.catch(() => {
        });
      };
      if (this.clerkjs && this.loaded) callback();
  ...
  */
  ...
  get __internal_protectChallengeLoadTimeoutMs() {
    var _a17;
    return (_a17 = this.clerkjs) == null ? void 0 : _a17.__internal_protectChallengeLoadTimeoutMs;
  }
  /**
...
function ClerkProviderGuard(props) {
  if (import_react5.default.useContext(ClerkInstanceContext)) errorThrower.throw(multipleClerkProvidersError);
  return import_react5.default.createElement(ClerkProviderBase, props);
}
